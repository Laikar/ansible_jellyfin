...
class ExternalIdInfo:
    ...
    type: Union[ExternalIdMediaType, None, Unset] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_type(data: object) -> Union[ExternalIdMediaType, None, Unset]:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(Union[ExternalIdMediaType, None, Unset], data)
