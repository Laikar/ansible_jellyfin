...
class BaseItemDto:
    ...
    extra_type: Union[None, Unset, str] = UNSET
    ...
    play_access: Union[None, PlayAccess, Unset] = UNSET
    ...
    collection_type: Union[None, Unset, str] = UNSET
    ...
    video_type: Union[None, Unset, VideoType] = UNSET
    ...
    location_type: Union[LocationType, None, Unset] = UNSET
    iso_type: Union[IsoType, None, Unset] = UNSET
    ...
    image_orientation: Union[ImageOrientation, None, Unset] = UNSET
    ...
    channel_type: Union[ChannelType, None, Unset] = UNSET
    audio: Union[None, ProgramAudio, Unset] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        video_3d_format: Union[None, Unset, str]
        ...
        play_access: Union[None, Unset, str]
        ...
        collection_type: Union[None, Unset, str]
        ...
        video_type: Union[None, Unset, str]
        ...
        location_type: Union[None, Unset, str]
        ...
        image_orientation: Union[None, Unset, str]
        ...
        channel_type: Union[None, Unset, str]
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_extra_type(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_video_3d_format(data: object) -> Union[None, Unset, Video3DFormat]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union[None, Unset, Video3DFormat], data)
        ...
        def _parse_play_access(data: object) -> Union[None, PlayAccess, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union[None, PlayAccess, Unset], data)
        ...
        def _parse_collection_type(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_video_type(data: object) -> Union[None, Unset, VideoType]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union[None, Unset, VideoType], data)
        ...
        def _parse_location_type(data: object) -> Union[LocationType, None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union[LocationType, None, Unset], data)

        location_type = _parse_location_type(d.pop("LocationType", UNSET))

        def _parse_iso_type(data: object) -> Union[IsoType, None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union[IsoType, None, Unset], data)
        ...
        def _parse_image_orientation(data: object) -> Union[ImageOrientation, None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union[ImageOrientation, None, Unset], data)
        ...
        def _parse_channel_type(data: object) -> Union[ChannelType, None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union[ChannelType, None, Unset], data)

        channel_type = _parse_channel_type(d.pop("ChannelType", UNSET))

        def _parse_audio(data: object) -> Union[None, ProgramAudio, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union[None, ProgramAudio, Unset], data)
