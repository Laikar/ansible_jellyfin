...
class PlaybackInfoResponse:
    ...
    error_code: Union[None, PlaybackErrorCode, Unset] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_error_code(data: object) -> Union[None, PlaybackErrorCode, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union[None, PlaybackErrorCode, Unset], data)
