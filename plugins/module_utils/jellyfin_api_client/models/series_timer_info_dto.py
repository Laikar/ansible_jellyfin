...
class SeriesTimerInfoDto:
    ...
    day_pattern: Union[DayPattern, None, Unset] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        day_pattern: Union[None, Unset, str]
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_day_pattern(data: object) -> Union[DayPattern, None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union[DayPattern, None, Unset], data)
