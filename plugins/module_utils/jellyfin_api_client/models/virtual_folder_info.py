...
class VirtualFolderInfo:
    ...
    collection_type: Union[CollectionTypeOptions, None, Unset] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_collection_type(data: object) -> Union[CollectionTypeOptions, None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union[CollectionTypeOptions, None, Unset], data)
