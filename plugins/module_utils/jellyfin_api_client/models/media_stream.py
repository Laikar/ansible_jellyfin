...
class MediaStream:
    ...
    video_range: Union[None, Unset, str] = UNSET
    video_range_type: Union[None, Unset, str] = UNSET
    ...
    delivery_method: Union[None, SubtitleDeliveryMethod, Unset] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        video_range: Union[None, Unset, str]
        if isinstance(self.video_range, Unset):
            video_range = UNSET
        else:
            video_range = self.video_range

        video_range_type: Union[None, Unset, str]
        ...
        delivery_method: Union[None, Unset, str]
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_video_range(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_video_range_type(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_delivery_method(data: object) -> Union[None, SubtitleDeliveryMethod, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union[None, SubtitleDeliveryMethod, Unset], data)
