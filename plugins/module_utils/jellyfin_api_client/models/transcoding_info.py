...
class TranscodingInfo:
    ...
    hardware_acceleration_type: Union[HardwareEncodingType, None, Unset] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_hardware_acceleration_type(data: object) -> Union[HardwareEncodingType, None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union[HardwareEncodingType, None, Unset], data)
