...
class MediaSourceInfo:
    ...
    encoder_protocol: Union[MediaProtocol, None, Unset] = UNSET
    ...
    timestamp: Union[None, TransportStreamTimestamp, Unset] = UNSET
    ...
    transcoding_sub_protocol: Union[None, Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        encoder_protocol: Union[None, Unset, str]
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_encoder_protocol(data: object) -> Union[MediaProtocol, None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union[MediaProtocol, None, Unset], data)
        ...
        def _parse_timestamp(data: object) -> Union[None, TransportStreamTimestamp, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union[None, TransportStreamTimestamp, Unset], data)
        ...
        def _parse_transcoding_sub_protocol(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
