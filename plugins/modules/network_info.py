...
from ansible_collections.laikar.jellyfin.plugins.module_utils.jellyfin_api_client.api.configuration import get_named_configuration
    ...
    with KeyClient(base_url = module.params['jellyfin_url'], 
        ...
        UserPassClient(base_url = module.params['jellyfin_url'], 
            ...
            match get_config_response.status_code:
                case 200:
                    result['network_config'] = get_config_response.parsed
